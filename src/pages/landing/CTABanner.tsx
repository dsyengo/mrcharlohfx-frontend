      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(6,182,212,0.4)]">
            Ready to start trading <span className="text-cyan-400">smarter?</span>
          </h2>
          <p className="text-xl text-cyan-100/80 max-w-2xl mx-auto">
            Join thousands of traders using <span className="text-cyan-400 font-semibold">MrChalohFx</span> to automate their strategies and maximize profits.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
            <Button variant="hero" size="lg" onClick={() => navigate('/login')} className="group bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white shadow-[0_0_25px_rgba(6,182,212,0.4)] hover:shadow-[0_0_40px_rgba(6,182,212,0.6)] transition-all duration-500">
              Login with Deriv
